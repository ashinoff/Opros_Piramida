...
# chief        — начальник: только просмотр (все РЭС), без изменений (права расширим позже)
ROLES = ("admin", "uploader", "staff", "res", "chief")

# 7 стандартных РЭС Сочинского региона — чтобы назначать пользователей ещё ДО
# первой выгрузки (иначе список РЭС берётся из загруженных ПУ и пуст).
# ВНИМАНИЕ: названия должны совпадать со значением колонки J (РЭС) в выгрузке
# Пирамиды — иначе РЭС-пользователь не увидит свои ПУ.
STANDARD_RES = [
    "Адлерский", "Дагомысский", "Краснополянский", "Лазаревский",
    "Сочинский", "Туапсинский", "Хостинский",
]
